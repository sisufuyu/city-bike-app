    ...
    <>
      <Box sx={{ mr: 2 }}>
        ...
        <Box sx={{ display: 'flex', my: 2 }}>
          ...
          <Typography>{formatAddress(station)}</Typography>
        </Box>
        <Box
          sx={{
            display: 'flex',
        ...
        >
          ...
          >
            <Typography>Journeys start from this station: &nbsp;</Typography>
            <Typography
        ...
        >
          ...
          >
            <Typography>Journeys return to this station: &nbsp;</Typography>
            <Typography
              fontFamily="Konnect Thin Italic"
              sx={{
                fontSize: {
